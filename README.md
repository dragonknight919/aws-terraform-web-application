...
This app can be deployed using Terraform v0.13.5 with provider.aws v3.14.1 and provider.archive v1.3.0, but later versions usually work in Terraform as well.
